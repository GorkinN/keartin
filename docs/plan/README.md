...
**Сейчас:** этап 6 выполнен (2026-09-23), ждёт приёмки. Отчёт в [stages/06-frontend.md](stages/06-frontend.md). Следующий код — [этап 7](stages/07-polish.md) после OK.
...
| 6 | Frontend | выполнен (2026-09-23), ждёт приёмки |

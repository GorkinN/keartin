...
Дата фиксации: 2026-09-20 (этапы 0–2). Приёмка этапа 2: 2026-09-21. Приёмка этапа 3: 2026-09-21. Приёмка этапа 4: 2026-09-21. Код этапа 5: 2026-09-22, приёмка не закрыта. Источник дефолтов: [plan/03-decisions.md](plan/03-decisions.md).
...
- Open folder: `explorer.exe` только для `fs`. Для `s3` — `400`.
- Имена моделей в мете поста — из env Nest, в SSE Python их нет.
- Второй generate не отвечает `409`: сериализация остаётся на lock GpuManager. Явный `409` — этап 7.
- Приёмка этапа 5 пользователем ещё не закрыта.
